sap.ui.define([
   ...
   "use strict";
    const ID_INPUT_NOME = "__xmlview0--formularionome";
    const ID_SELECT_TIPO = "__xmlview0--formulariotipo";
    const ID_INPUT_QUANTIDADE = "__xmlview0--formularioquantidade";
        ...
        validarFormulario: function() {
            ...
            campos.forEach(campo => {
                ...
                if (!valor || (campo.id === ID_INPUT_QUANTIDADE && valor < 0)) {
                    ...
                    this.byId(campo.id).setValueStateText(this._oResourceBundle.getText(`${campo.chave} é obrigatorio`));
